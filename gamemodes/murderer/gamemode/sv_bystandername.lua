...
addPart("dio")
addPart("jojo")
addPart("father in love")
addPart("brotherhood")
addPart("arouf")
addPart("trap")
addPart("surprise")
addPart("jesus")
addPart("raptor jesus")
addPart("cyberfrank")
addPart("dildo")
addPart("java")
addPart("juda")
...
addPart("transistor")
addPart("kim jung un")
addPart("kim jung dos")
addPart("kim jung tres")
addPart("alpha man")
addPart("billy")
addPart("FUTABU")
addPart("gigi")
addPart("JEAN CAST3X")
addPart("dragon balle z")
