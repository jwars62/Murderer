...
GM.LocalChatRange = CreateConVar("mu_localchat_range", 9999, bit.bor(FCVAR_NOTIFY), "The range at which you can hear other players" )
...
GM.RoundLimit = CreateConVar("mu_roundlimit", 10, bit.bor(FCVAR_NOTIFY), "Number of rounds we should play before map change" )
...
GM.FlashlightBattery = CreateConVar("mu_flashlight_battery", 250, bit.bor(FCVAR_NOTIFY), "How long the flashlight should last in seconds (0 for infinite)" )
GM.Language = CreateConVar("mu_language", "", bit.bor(FCVAR_NOTIFY), "The language Murder should use" )
GM.delai = CreateConVar("mu_delai", 8, bit.bor(FCVAR_NOTIFY), "delay before the appearance of the next clue", 1 )
GM.pb1 = CreateConVar("mu_pb1", 3, bit.bor(FCVAR_NOTIFY), "nombre d'indice requis pour obtenir la 1ere recompence (bystander)")
GM.pb2 = CreateConVar("mu_pb2", 5, bit.bor(FCVAR_NOTIFY), "nombre d'indice requis pour obtenir la 2eme recompence (bystander)")
GM.pb3 = CreateConVar("mu_pb3", 8, bit.bor(FCVAR_NOTIFY), "nombre d'indice requis pour obtenir la 3eme recompence (bystander)" )
GM.pm1 = CreateConVar("mu_pm1", 2, bit.bor(FCVAR_NOTIFY), "nombre d'indice requis pour obtenir la 1ere recompence (murder)" )
GM.pm2 = CreateConVar("mu_pm2", 4, bit.bor(FCVAR_NOTIFY), "nombre d'indice requis pour obtenir la 2eme recompence (murder)" )
GM.pm3 = CreateConVar("mu_pm3", 6, bit.bor(FCVAR_NOTIFY), "nombre d'indice requis pour obtenir la 3eme recompence (murder)" )
GM.pm4 = CreateConVar("mu_pm4", 8, bit.bor(FCVAR_NOTIFY), "nombre d'indice requis pour obtenir la 4eme recompence (murder)" )
GM.lsr = CreateConVar("mu_loot_start_respawn", 1, bit.bor(FCVAR_NOTIFY), "fait réaparaitre tout les indices au début du round", 0, 1 )
