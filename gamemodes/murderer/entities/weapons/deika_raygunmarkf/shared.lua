...
SWEP.Author            = "Me for fixing this thing"
SWEP.Contact        = ""
SWEP.Purpose        = ""
SWEP.Instructions    = "Bring me 115"

if CLIENT then

    SWEP.PrintName = "Raygun Mk. II"            
	...
	SWEP.ViewModel = "models/weapons/v_bo2_raygunmk2.mdl"
	...
	SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/lilrobot/raygunmk2/raygunmk2.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(5.697, 1.447, -1.308), angle = Angle(-85.336, -154.926, -64.287), size = Vector(1.065, 1.065, 1.065), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.Primary.Sound             = Sound("weapons/raygun2/raygunmk2fire.wav")
...
SWEP.IronSightsPos = Vector(-14.16, -11.506, 1.919)
...
function SWEP:Reload()
	if ( self:Clip1() < self.Primary.ClipSize && self:Ammo1() > 0 ) then
		...
		self:EmitSound( "weapons/raygun2/reygunreload.wav" )
...
function SWEP:Deploy()
	...
	self:EmitSound( "weapons/raygun2/clipin.wav" )
      return true
end
